package com.example.amangupta.pulltoload.adapter;
...
import com.example.amangupta.pulltoload.R;
...
public class MyRecycleViewAdapter extends RecyclerView.Adapter<MyRecycleViewAdapter.MyHolder> {
    ...
    public void onBindViewHolder(MyHolder holder, int position) {
        ...
        holder.textView.setText(Controller.getController().getList().get(position));
    }

    @Override
    public int getItemCount() {
        return Controller.getController().getList().size();
    }
