...
public class DemonetisationRecycleViewAdapter extends RecyclerView.Adapter<DemonetisationRecycleViewAdapter.DemonetisationViewHolder> {
    Context context;
    List<Tweet> tweets;
    OnLoadMore onLoadMore;

    public DemonetisationRecycleViewAdapter(Context context,List<Tweet> tweets,OnLoadMore onLoadMore) {
    ...
    @Override
    public DemonetisationViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_tweet, parent, false);
        DemonetisationViewHolder holder = new DemonetisationViewHolder(view);
        return holder;
    }

    @Override
    public void onBindViewHolder(DemonetisationViewHolder holder, final int position) {
    ...
    public class DemonetisationViewHolder extends RecyclerView.ViewHolder{
        ImageView profileImage;
        TextView profileName;
        TextView createTime;
        TextView tweetContent;
        ImageView tweetImage;
        public DemonetisationViewHolder(View itemView) {
            super(itemView);
